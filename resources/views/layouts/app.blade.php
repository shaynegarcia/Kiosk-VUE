...
<head>
    <head>
        ...
        <link rel="stylesheet" id="css-main" href="{{asset('pos/pos.css')}}">
    ...
    <body>
        ...
        -->
        <div id="app">
            <div id="page-container" class="{{ $class ?? '' }}">
                <!-- Side Overlay-->
                <aside id="side-overlay" class="font-size-sm">
                    @include('dashboard.inc.right_sidebar')
                </aside>
                <!-- END Side Overlay -->
               ...
               <nav id="sidebar" aria-label="Main Navigation">
                @include('dashboard.inc.left_sidebar')
               </nav>
                <!-- END Sidebar -->
